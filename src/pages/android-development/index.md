...
There is definitely a learning curve to get used to the Android framework, however,  once you understand the core components that make up the app,  rest will come naturally.
